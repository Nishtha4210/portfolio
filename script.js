...
function initScrollAnimations() {
    ...
    const animateElements = document.querySelectorAll('.about-image, .about-content, .skill-item, .project-card, .contact-item');
...
// Initialize Particles.js with coding-themed elements
    ...
    if (typeof particlesJS !== 'undefined') {
        particlesJS('particles-js', {
            "particles": {
                ...
                "color": {
                    "value": ["#00d4ff", "#ff6b6b", "#4ecdc4", "#45b7d1", "#96ceb4", "#feca57"]
                },
                "shape": {
